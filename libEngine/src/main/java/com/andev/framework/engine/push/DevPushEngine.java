package com.andev.framework.engine.push;

import java.util.Map;

import com.andev.framework.engine.DevEngineAssist;
import com.andev.framework.engine.push.IPushEngine.EngineConfig;
import com.andev.framework.engine.push.IPushEngine.EngineItem;
...
public final class DevPushEngine {
    ...
    private static final DevEngineAssist<IPushEngine<? super EngineConfig, ? super EngineItem>> sAssist = new DevEngineAssist<>();
     ...
     * @return {@link IPushEngine}
     */
    public static IPushEngine<? super EngineConfig, ? super EngineItem> getEngine(final String key) {
