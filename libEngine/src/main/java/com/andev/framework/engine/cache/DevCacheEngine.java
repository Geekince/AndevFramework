...
public final class DevCacheEngine {
    ...
    private static final DevEngineAssist<ICacheEngine<? super ICacheEngine.EngineConfig, ? super ICacheEngine.EngineItem>> sAssist = new DevEngineAssist<>();
     ...
     */
    public static ICacheEngine<? super ICacheEngine.EngineConfig, ? super ICacheEngine.EngineItem> getEngine() {
     ...
     * @return {@link ICacheEngine}
     */
    public static ICacheEngine<? super ICacheEngine.EngineConfig, ? super ICacheEngine.EngineItem> getEngine(final String key) {
     ...
     */
    public static DevEngineAssist<ICacheEngine<? super ICacheEngine.EngineConfig, ? super ICacheEngine.EngineItem>> getAssist() {
        return sAssist;
    }
     ...
     * @return Engine Map
     */
    public static Map<String, ICacheEngine<? super ICacheEngine.EngineConfig, ? super ICacheEngine.EngineItem>> getEngineMaps() {
